function onePageScroll(e, t) {
    ...
    if (window.location.hash != "" && window.location.hash != "#1") {
      var r = window.location.hash.replace("#", ""),
        u = document.querySelector(
          i.sectionContainer + "[data-index='" + r + "']"
        ),
        a = u.dataset.index;
      _addClass(
        document.querySelector(i.sectionContainer + "[data-index='" + r + "']"),
        "active"
      );
      ...
      if (i.pagination == true)
        _addClass(
          document.querySelector(
            ".onepage-pagination li a" + "[data-index='" + r + "']"
          ),
          "active"
        );
      if (u) {
      ...
      _addClass(
        document.querySelector(i.sectionContainer + "[data-index='1']"),
        "active"
      );
  ...
  _init_scroll = function(e, t) {
    var n = t,
      r = new Date().getTime();
    if (r - l < c + i.animationTime +  i.delay) {
      e.preventDefault();
      return;
    }
    if (n < 0) {
  ...
  this.moveDown = function(e) {
    ...
    var t = document.querySelector(i.sectionContainer + ".active").dataset
        .index,
      n = document.querySelector(
        i.sectionContainer + "[data-index='" + t + "']"
      ),
      r = document.querySelector(
        i.sectionContainer + "[data-index='" + (parseInt(t) + 1) + "']"
      );
    if (!r) {
      if (i.loop == true) {
        pos = 0;
    ...
    if (i.pagination == true) {
      ...
      _addClass(
        document.querySelector(
          ".onepage-pagination li a" + "[data-index='" + s + "']"
        ),
        "active"
      );
    }
